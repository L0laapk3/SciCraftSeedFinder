...
# Quad huts in the closest possible configuration (1/65000 quad hut seeds).
...
# Quad huts, all the biomes, ocean spawn, and a close mansion.
# java -jar dist/seedfinder.jar Everything          1000000000000 5 >>    everything-001000000000000.log &
# java -jar dist/seedfinder.jar Everything         51000000000000 5 >>    everything-051000000000000.log &
# java -jar dist/seedfinder.jar Everything        101000000000000 5 >>    everything-101000000000000.log &
# java -jar dist/seedfinder.jar Everything        151000000000000 5 >>    everything-151000000000000.log &
# java -jar dist/seedfinder.jar Everything        201000000000000 5 >>    everything-201000000000000.log &
